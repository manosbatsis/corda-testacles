 ...
 * USA
 */
package testacles.sample.test.workflow
...
import testacles.sample.cordapp.workflow.YoFlow2
...
class YoFlowTests {
    ...
    val cordappPackages = listOf(YoContract.ID, this.javaClass.`package`.name, "com.github.manosbatsis.partiture.flow")
