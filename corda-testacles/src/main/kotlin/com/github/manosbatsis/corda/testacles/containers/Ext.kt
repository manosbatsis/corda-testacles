...
fun Config.getUsers(): MutableList<out Config> {
    return if (this.hasPath("rpcUsers")) {
        // TODO: remove this once config format is updated
        this.getConfigList("rpcUsers")
    } else {
        this.getConfigList("security.authService.dataSource.users")
    }
}
