...
class MockNetworkExtension:
    ...
    override fun beforeAll(extensionContext: ExtensionContext) = startNatework(extensionContext)

    /** Stop the Corda [MockNetwork] */
    override fun afterAll(extensionContext: ExtensionContext) = stopNetwork(extensionContext)
}